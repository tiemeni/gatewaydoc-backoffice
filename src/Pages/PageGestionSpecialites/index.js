    ...
    return (
        <Box style={styles.container}>
            <Grid item xs={12} style={styles.titleBox}>
                <Typography sx={styles.title}>Gestion des Spécialités</Typography>
            </Grid>
            <Box style={{ display: "flex", flexDirection: "row", justifyContent: "center", width: "100%" }}>
                <Box style={{ paddingLeft: 15, paddingRight: 15, width: "95%" }}>
                    <Box style={styles.sectionTitle} mt={2}>
                        <Typography fontSize={14}>Gestion des Spécialités</Typography>
                    </Box>
                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                <TableCell sx={styles.fs14} >Actions</TableCell>
                                <TableCell sx={styles.fs14} >Spécialités</TableCell>
                                <TableCell sx={styles.fs14} >Alerts</TableCell>
                                <TableCell sx={styles.fs14} >Actions</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {users.map((user) => (
                                <TableRow key={user.id}>
                                    <TableCell sx={styles.fs14}>
                                        ...
                                        <div style={{}}>
                                            <EditOutlinedIcon style={{ height: 25, width: 25, cursor: "pointer" }} />
                                            <DeleteOutlinedIcon style={{ height: 25, width: 25, cursor: "pointer", color: "red", marginLeft: 15 }} />
                                        </div>
                                    </TableCell>
